...
// 4) The .goalyrc JSON Schema (improvement plan 3.2) — generated by `npm run gen:schema` (which
//    `npm run build` runs first), copied next to the CLI so editors can reference it from an install.
await cp('goalyrc.schema.json', 'dist/goalyrc.schema.json');
